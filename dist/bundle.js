...
var _stock = __webpack_require__(29);
...
var StockBooks = function (_React$Component) {
	_inherits(StockBooks, _React$Component);

	function StockBooks() {
		_classCallCheck(this, StockBooks);

		return _possibleConstructorReturn(this, (StockBooks.__proto__ || Object.getPrototypeOf(StockBooks)).apply(this, arguments));
	}

	_createClass(StockBooks, [{
		key: 'render',
		value: function render() {
			return _react2.default.createElement(
				'div',
				null,
				'StockBooks - Available books by boobalan'
			);
		}
	}]);
